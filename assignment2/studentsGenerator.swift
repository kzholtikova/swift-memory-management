...
func generateStudentsJSON(_ desiredFileSizeInBytes: Int) {
    // Main code to generate the JSON file
    let fileURL = URL(fileURLWithPath: #file).deletingLastPathComponent().appendingPathComponent("students.json")
